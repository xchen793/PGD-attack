...
def main(args):
    ...
    random_vectors = (torch.randn(K, dim) - 0.5)
    random_vectors = normalize(random_vectors, p=2.0, dim = 1)
    key_list, bucket_embed_idx_list, buckets, avg_vectors = k_means_centroids(embeddings, random_vectors, max_iter = 100)
